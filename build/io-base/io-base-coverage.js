...
if (!Y.UA.ie) {
                    _yuitest_coverline("build/io-base/io-base.js", 711);
...
for (i = 0, len = XHR_PROPS.length; i < len; ++i) {
                    _yuitest_coverline("build/io-base/io-base.js", 724);
response[XHR_PROPS[i]] = transaction.c[XHR_PROPS[i]];
                }

                _yuitest_coverline("build/io-base/io-base.js", 727);
response.getAllResponseHeaders = function() {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getAllResponseHeaders", 727);
_yuitest_coverline("build/io-base/io-base.js", 728);
return transaction.c.getAllResponseHeaders();
                };

                _yuitest_coverline("build/io-base/io-base.js", 731);
response.getResponseHeader = function(name) {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getResponseHeader", 731);
_yuitest_coverline("build/io-base/io-base.js", 732);
return transaction.c.getResponseHeader(name);
                };

                _yuitest_coverline("build/io-base/io-base.js", 735);
io.complete(transaction, config);
                _yuitest_coverline("build/io-base/io-base.js", 736);
io._result(transaction, config);

                _yuitest_coverline("build/io-base/io-base.js", 738);
return response;
            }
        } catch(e) {
            _yuitest_coverline("build/io-base/io-base.js", 741);
if (transaction.xdr) {
...
return io._retry(transaction, uri, config);
                ...
                _yuitest_coverline("build/io-base/io-base.js", 750);
io.complete(transaction, config);
                _yuitest_coverline("build/io-base/io-base.js", 751);
io._result(transaction, config);
            }
        }
        ...
        _yuitest_coverline("build/io-base/io-base.js", 757);
if (config.timeout) {
            _yuitest_coverline("build/io-base/io-base.js", 758);
io._startTimeout(transaction, config.timeout);
        }

        _yuitest_coverline("build/io-base/io-base.js", 761);
return {
            id: transaction.id,
            abort: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "abort", 763);
_yuitest_coverline("build/io-base/io-base.js", 764);
return transaction.c ? io._abort(transaction, 'abort') : false;
            },
            isInProgress: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "isInProgress", 766);
_yuitest_coverline("build/io-base/io-base.js", 767);
...
@for YUI
**/
_yuitest_coverline("build/io-base/io-base.js", 879);
Y.io = function(url, config) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "io", 879);
_yuitest_coverline("build/io-base/io-base.js", 882);
var transaction = Y.io._map['io:0'] || new IO();
    _yuitest_coverline("build/io-base/io-base.js", 883);
...
@static
**/
_yuitest_coverline("build/io-base/io-base.js", 897);
Y.io.header = function(name, value) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "header", 897);
_yuitest_coverline("build/io-base/io-base.js", 900);
var transaction = Y.io._map['io:0'] || new IO();
...
_yuitest_coverline("build/io-base/io-base.js", 906);
Y.io._map = {};
...
_yuitest_coverline("build/io-base/io-base.js", 912);
Y.mix(Y.IO, {
    /**
    ...
    */
    defaultTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "defaultTransport", 927);
_yuitest_coverline("build/io-base/io-base.js", 928);
if (id) {
            _yuitest_coverline("build/io-base/io-base.js", 929);
Y.IO._default = id;
        } else {
...
var o = {
            ...
            _yuitest_coverline("build/io-base/io-base.js", 935);
return o;
        }
    },
    /**
    ...
    */
    transports: {
        xhr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xhr", 945);
_yuitest_coverline("build/io-base/io-base.js", 946);
return XHR ? new XMLHttpRequest() :
                AX ? new ActiveXObject('Microsoft.XMLHTTP') : null;
        },
        xdr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xdr", 949);
_yuitest_coverline("build/io-base/io-base.js", 950);
return XDR ? new XDomainRequest() : null;
        },
        iframe: function () { _yuitest_coverfunc("build/io-base/io-base.js", "iframe", 952);
...
return {}; },
    ...
    */
    customTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "customTransport", 962);
_yuitest_coverline("build/io-base/io-base.js", 963);
var o = { c: Y.IO.transports[id]() };

        _yuitest_coverline("build/io-base/io-base.js", 965);
o[(id === 'xdr' || id === 'flash') ? 'xdr' : 'notify'] = true;
        _yuitest_coverline("build/io-base/io-base.js", 966);
return o;
    }
});

_yuitest_coverline("build/io-base/io-base.js", 970);
Y.mix(Y.IO.prototype, {
    ...
    */
    notify: function(event, transaction, config) {
        _yuitest_coverfunc("build/io-base/io-base.js", "notify", 979);
_yuitest_coverline("build/io-base/io-base.js", 980);
var io = this;
...
switch (event) {
            ...
            case 'transport error':
                _yuitest_coverline("build/io-base/io-base.js", 986);
transaction.c = { status: 0, statusText: event };
                _yuitest_coverline("build/io-base/io-base.js", 987);
event = 'failure';
            default:
