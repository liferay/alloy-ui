AUI.add('aui-datepicker-base-deprecated', function(A) {
var Lang = A.Lang,
...
AUI.add('aui-datepicker-select-deprecated', function(A) {
/**
...
}, '@VERSION@' ,{skinnable:true, requires:['aui-datepicker-base-deprecated','aui-button-item']});


AUI.add('aui-datepicker-deprecated', function(A){}, '@VERSION@' ,{skinnable:true, use:['aui-datepicker-base-deprecated','aui-datepicker-select-deprecated']});
