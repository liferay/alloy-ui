...
_yuitest_coverage["build/yui-nodejs/yui-nodejs.js"].coveredLines = 822;
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3565);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3566);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3567);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3568);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3569);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3570);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3571);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3572);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3573);
if ((/rhino/i).test(ua)) {
...
if (m && m[1]) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3590);
...
o.mobile = 'Apple'; // iPhone or iPod Touch
                ...
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3604);
m = ua.match(/OS ([^\s]*)/);
...
if (m && m[0]) {
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3614);
...
o.silk = numberify(m[1]);
                    ...
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3644);
if (!o.android) {
...
o.accel = true;
            ...
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3654);
...
o.safari = 0; //Reset safari back to 0
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3658);
if (m[1] === 'CrMo') {
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3659);
o.mobile = 'chrome';
                }
            } else {
...
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3672);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3673);
if (m && m[1]) {
...
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3682);
o.mobile = 'opera';
...
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3699);
if (m) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3700);
...
if (!subUA) {
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3714);
if (typeof process == 'object') {

            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3716);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3718);
o.os = process.platform;
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3719);
o.nodejs = numberify(process.versions.node);
            }
        }

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3723);
YUI.Env.UA = o;
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "compareVersions", 3753);
...
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3765);
bPart = parseInt(bParts[i], 10);
...
if (aPart < bPart) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3771);
return -1;
        }

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3774);
if (aPart > bPart) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3775);
return 1;
        }
    }

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3779);
return 0;
};
...
}, '3.7.2', {"use": ["yui-base", "get", "features", "intl-base", "yui-log", "yui-log-nodejs", "yui-later", "loader-base", "loader-rollup", "loader-yui3"]});
