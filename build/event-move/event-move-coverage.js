...
_yuitest_coverage["build/event-move/event-move.js"].lines = {"1":0,"12":0,"49":0,"52":0,"53":0,"56":0,"60":0,"64":0,"65":0,"66":0,"67":0,"68":0,"69":0,"70":0,"71":0,"73":0,"77":0,"79":0,"80":0,"118":0,"122":0,"132":0,"134":0,"136":0,"142":0,"144":0,"145":0,"146":0,"151":0,"153":0,"154":0,"155":0,"160":0,"162":0,"163":0,"166":0,"167":0,"170":0,"175":0,"176":0,"179":0,"188":0,"189":0,"190":0,"192":0,"195":0,"199":0,"201":0,"203":0,"204":0,"208":0,"210":0,"213":0,"215":0,"216":0,"220":0,"223":0,"224":0,"225":0,"234":0,"235":0,"236":0,"238":0,"239":0,"240":0,"242":0,"243":0,"244":0,"250":0,"251":0,"254":0,"257":0,"258":0,"299":0,"303":0,"312":0,"317":0,"319":0,"321":0,"327":0,"329":0,"330":0,"331":0,"336":0,"338":0,"339":0,"340":0,"346":0,"351":0,"352":0,"355":0,"359":0,"361":0,"362":0,"363":0,"365":0,"369":0,"371":0,"374":0,"375":0,"417":0,"421":0,"430":0,"435":0,"437":0,"439":0,"445":0,"447":0,"448":0,"449":0,"455":0,"457":0,"458":0,"459":0,"464":0,"469":0,"470":0,"473":0,"476":0,"478":0,"479":0,"480":0,"482":0,"486":0,"488":0,"490":0,"491":0,"493":0,"494":0};
_yuitest_coverage["build/event-move/event-move.js"].functions = {"_defArgsProcessor:48":0,"_getRoot:59":0,"_normTouchFacade:63":0,"_prevent:76":0,"on:120":0,"(anonymous 2):135":0,"delegate:130":0,"detachDelegate:141":0,"detach:150":0,"processArgs:159":0,"(anonymous 3):215":0,"(anonymous 4):223":0,"_onStart:173":0,"_cancel:233":0,"_start:248":0,"on:301":0,"(anonymous 5):320":0,"delegate:315":0,"detach:326":0,"detachDelegate:335":0,"processArgs:345":0,"_onMove:349":0,"on:419":0,"(anonymous 6):438":0,"delegate:433":0,"detachDelegate:444":0,"detach:454":0,"processArgs:463":0,"_onEnd:467":0,"(anonymous 1):1":0};
...
var GESTURE_MAP = Y.Event._GESTURE_MAP,
    ...
    _defArgsProcessor = function(se, args, delegate) {
        _yuitest_coverfunc("build/event-move/event-move.js", "_defArgsProcessor", 48);
_yuitest_coverline("build/event-move/event-move.js", 49);
...
touchFacade[BUTTON] = (params && params[BUTTON]) || 1; // default to left (left as per vendors, not W3C which is 0)
    ...
    _prevent = function(e, preventDefault) {
        _yuitest_coverfunc("build/event-move/event-move.js", "_prevent", 76);
...
define(GESTURE_MOVE_START, {
    ...
    on: function (node, subscriber, ce) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "on", 120);
...
subscriber[_MOVE_START_HANDLE] = node.on(EVENT[START], 
    ...
    delegate : function(node, subscriber, ce, filter) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "delegate", 130);
...
subscriber[_DEL_MOVE_START_HANDLE] = node.delegate(EVENT[START],
            function(e) {
                _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 2)", 135);
...
se._onStart(e, node, subscriber, ce, true);
    ...
    detachDelegate : function(node, subscriber, ce, filter) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detachDelegate", 141);
_yuitest_coverline("build/event-move/event-move.js", 142);
...
subscriber[_DEL_MOVE_START_HANDLE] = null;
    ...
    detach: function (node, subscriber, ce) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detach", 150);
_yuitest_coverline("build/event-move/event-move.js", 151);
...
subscriber[_MOVE_START_HANDLE] = null;
    ...
    processArgs : function(args, delegate) {
        _yuitest_coverfunc("build/event-move/event-move.js", "processArgs", 159);
_yuitest_coverline("build/event-move/event-move.js", 160);
var params = _defArgsProcessor(this, args, delegate);

        _yuitest_coverline("build/event-move/event-move.js", 162);
...
return params;
    ...
    _onStart : function(e, node, subscriber, ce, delegate) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "_onStart", 173);
...
params._hme = root.on(EVENT[END], Y.bind(function() {
                        _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 3)", 215);
...
params._hm = root.on(EVENT[MOVE], Y.bind(function(em) {
                        _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 4)", 223);
...
this._start(e, node, ce, params);
    ...
    _cancel : function(params) {
        _yuitest_coverfunc("build/event-move/event-move.js", "_cancel", 233);
...
params._hm = null;
    ...
    _start : function(e, node, ce, params) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "_start", 248);
...
define(GESTURE_MOVE, {
    ...
    on : function (node, subscriber, ce) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "on", 301);
...
var root = _getRoot(node, subscriber),
        ...
        _yuitest_coverline("build/event-move/event-move.js", 312);
subscriber[_MOVE_HANDLE] = moveHandle;
    },

    delegate : function(node, subscriber, ce, filter) {

        _yuitest_coverfunc("build/event-move/event-move.js", "delegate", 315);
...
subscriber[_DEL_MOVE_HANDLE] = node.delegate(EVENT[MOVE],
            function(e) {
                _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 5)", 320);
...
se._onMove(e, node, subscriber, ce, true);
    ...
    detach : function (node, subscriber, ce) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detach", 326);
_yuitest_coverline("build/event-move/event-move.js", 327);
...
subscriber[_MOVE_HANDLE] = null;
    ...
    detachDelegate : function(node, subscriber, ce, filter) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detachDelegate", 335);
_yuitest_coverline("build/event-move/event-move.js", 336);
...
subscriber[_DEL_MOVE_HANDLE] = null;
    ...
    processArgs : function(args, delegate) {
        _yuitest_coverfunc("build/event-move/event-move.js", "processArgs", 345);
...
return _defArgsProcessor(this, args, delegate);
    ...
    _onMove : function(e, node, subscriber, ce, delegate) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "_onMove", 349);
...
if (fireMove) {
            ...
            _yuitest_coverline("build/event-move/event-move.js", 361);
if (e.touches) {
...
define(GESTURE_MOVE_END, {
    ...
    on : function (node, subscriber, ce) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "on", 419);
...
subscriber[_MOVE_END_HANDLE] = endHandle;
    ...
    delegate : function(node, subscriber, ce, filter) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "delegate", 433);
_yuitest_coverline("build/event-move/event-move.js", 435);
var se = this;

        _yuitest_coverline("build/event-move/event-move.js", 437);
subscriber[_DEL_MOVE_END_HANDLE] = node.delegate(EVENT[END],
            function(e) {
                _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 6)", 438);
...
se._onEnd(e, node, subscriber, ce, true);
    ...
    detachDelegate : function(node, subscriber, ce, filter) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detachDelegate", 444);
...
subscriber[_DEL_MOVE_END_HANDLE] = null;
    ...
    detach : function (node, subscriber, ce) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detach", 454);
...
subscriber[_MOVE_END_HANDLE] = null;
    ...
    processArgs : function(args, delegate) {
        _yuitest_coverfunc("build/event-move/event-move.js", "processArgs", 463);
...
return _defArgsProcessor(this, args, delegate);
    ...
    _onEnd : function(e, node, subscriber, ce, delegate) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "_onEnd", 467);
