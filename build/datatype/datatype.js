...
YUI.add('datatype-number', function(Y){}, '3.4.0' ,{use:['datatype-number-parse', 'datatype-number-format']});
...
YUI.add('datatype-date', function(Y){}, '3.4.0' ,{use:['datatype-date-parse', 'datatype-date-format']});
...
YUI.add('datatype-xml', function(Y){}, '3.4.0' ,{use:['datatype-xml-parse', 'datatype-xml-format']});



YUI.add('datatype', function(Y){}, '3.4.0' ,{use:['datatype-number', 'datatype-date', 'datatype-xml']});
