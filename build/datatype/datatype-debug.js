...
YUI.add('datatype-number', function(Y){}, '3.2.0PR1' ,{use:['datatype-number-parse', 'datatype-number-format']});
...
YUI.add('datatype', function(Y){}, '3.2.0PR1' ,{use:['datatype-number', 'datatype-date', 'datatype-xml']});
