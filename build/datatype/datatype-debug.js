...
YUI.add('datatype-number', function(Y){}, '3.1.1' ,{use:['datatype-number-parse', 'datatype-number-format']});
...
YUI.add('datatype', function(Y){}, '3.1.1' ,{use:['datatype-number', 'datatype-date', 'datatype-xml']});
