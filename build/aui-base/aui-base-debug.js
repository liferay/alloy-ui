	...
	window.AUI = {
		defaults: {
			...
			modules: {
				...
				'aui-calendar': {submodules: {'aui-calendar-datepicker-select': {skinnable:true, requires:['aui-calendar-base','aui-tool-item']}, 'aui-calendar-base': {skinnable:true, requires:['aui-context-overlay','datatype-date','widget-locale']} }, skinnable:true, use:['aui-calendar-base','aui-calendar-datepicker-select']},
