		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-scheduler': {submodules: {'aui-scheduler-event-recorder': {skinnable:true, requires:['aui-scheduler-base','aui-template','aui-toolbar','io-form','querystring','overlay']}, 'aui-scheduler-view-month': {skinnable:true, requires:['aui-scheduler-view-table']}, 'aui-scheduler-view-table-dd': {skinnable:false, requires:['aui-scheduler-view-table','dd-drag','dd-delegate','dd-drop','dd-constrain']}, 'aui-scheduler-view-table': {skinnable:true, requires:['aui-scheduler-base','overlay']}, 'aui-scheduler-view-week': {skinnable:true, requires:['aui-scheduler-view-day']}, 'aui-scheduler-view-day': {skinnable:true, requires:['aui-scheduler-view-table','dd-drag','dd-delegate','dd-drop','dd-constrain']}, 'aui-scheduler-base': {skinnable:true, requires:['aui-base','aui-color-util','aui-datatype','button-group','model','model-list','widget-stdmod']} }, use:['aui-scheduler-base','aui-scheduler-view-day','aui-scheduler-view-week','aui-scheduler-view-table','aui-scheduler-view-table-dd','aui-scheduler-view-month','aui-scheduler-event-recorder'], skinnable:false},
