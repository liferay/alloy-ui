			...
			groups: {
                alloy: {
                    ...
                    modules: {
						...
						'aui-color-picker': {requires:['aui-overlay-context','dd','slider','substitute','aui-tool-item','aui-form','aui-panel'], skinnable:true},
