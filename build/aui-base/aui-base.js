	...
	window.AUI = {
		defaults: {
			...
			modules: {
				...
				'aui-io': {submodules: {'aui-io-plugin': {requires:['aui-component-overlay','aui-parse-content','aui-io-request','aui-loading-mask']}, 'aui-io-request': {requires:['aui-base','io','json','plugin']} }, skinnable:false, use:['aui-io-request','aui-io-plugin']},
				...
				'aui-node': {submodules: {'aui-node-html5': {requires:['collection','aui-base']}, 'aui-node-base': {requires:['aui-base']} }, use:['aui-node-base','aui-node-html5'], skinnable:false},
