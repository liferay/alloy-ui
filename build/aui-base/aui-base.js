	...
	var AUI_config = {
		...
		groups: {
            alloy: {
				combine: false,
                modules: {
						'aui-ace-autocomplete': {requires:['aui-ace-editor','aui-overlay-base','plugin','aui-search-ternary-search-tree','aui-io-request','widget-autohide'], skinnable:true},
