YUI.add('aui-scroller-deprecated', function (A, NAME) {
...
var Scroller = A.Component.create({
    ...
    prototype: {
        ...
        bindUI: function() {
            ...
            contentBox.on('mousemove', A.rbind(instance._onMouseMove, instance, instance._boundingBox, instance._contentBox,
