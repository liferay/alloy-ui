...
return Y.one(this._node.replaceChild(Y_Node.getDOMNode(node), Y_Node.getDOMNode(refNode)));
    ...
    destroy: function(recursive) {
        _yuitest_coverfunc("build/node-core/node-core.js", "destroy", 716);
_yuitest_coverline("build/node-core/node-core.js", 717);
var UID = Y.config.doc.uniqueID ? 'uniqueID' : '_yuid',
            instance;

        _yuitest_coverline("build/node-core/node-core.js", 720);
this.purge(); // TODO: only remove events add via this Node

        _yuitest_coverline("build/node-core/node-core.js", 722);
if (this.unplug) { // may not be a PluginHost
            _yuitest_coverline("build/node-core/node-core.js", 723);
this.unplug();
        }

        _yuitest_coverline("build/node-core/node-core.js", 726);
this.clearData();
...
Y.NodeList.each(this.all('*'), function(node) {
                _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 6)", 729);
...
delete Y_Node._instances[this._yuid];
    ...
    invoke: function(method, a, b, c, d, e) {
        _yuitest_coverfunc("build/node-core/node-core.js", "invoke", 755);
_yuitest_coverline("build/node-core/node-core.js", 756);
var node = this._node,
            ret;

        _yuitest_coverline("build/node-core/node-core.js", 759);
if (a && a._node) {
            _yuitest_coverline("build/node-core/node-core.js", 760);
a = a._node;
        }
...
return Y_Node.scrubVal(ret, this);
    ...
    */
    swap: Y.config.doc.documentElement.swapNode ?
        function(otherNode) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 7)", 779);
_yuitest_coverline("build/node-core/node-core.js", 780);
this._node.swapNode(Y_Node.getDOMNode(otherNode));
        } :
        function(otherNode) {
            _yuitest_coverfunc("build/node-core/node-core.js", "}", 782);
_yuitest_coverline("build/node-core/node-core.js", 783);
otherNode = Y_Node.getDOMNode(otherNode);
            _yuitest_coverline("build/node-core/node-core.js", 784);
var node = this._node,
...
parent.insertBefore(node, otherNode);
            } else {_yuitest_coverline("build/node-core/node-core.js", 790);
...
return this;
    ...
    hasMethod: function(method) {
        _yuitest_coverfunc("build/node-core/node-core.js", "hasMethod", 800);
_yuitest_coverline("build/node-core/node-core.js", 801);
var node = this._node;
        _yuitest_coverline("build/node-core/node-core.js", 802);
return !!(node && method in node &&
    ...
    isFragment: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "isFragment", 808);
_yuitest_coverline("build/node-core/node-core.js", 809);
return (this.get('nodeType') === 11);
     ...
     */
    empty: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "empty", 817);
...
return this;
     ...
     */
    getDOMNode: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "getDOMNode", 827);
...
var NodeList = function(nodes) {
    _yuitest_coverfunc("build/node-core/node-core.js", "NodeList", 850);
_yuitest_coverline("build/node-core/node-core.js", 851);
var tmp = [];
...
nodes = Y.Selector.query(nodes);
        } else {_yuitest_coverline("build/node-core/node-core.js", 857);
...
Y.Array.each(nodes, function(node) {
                _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 8)", 862);
...
nodes = Y.Array(nodes, 0, true);
     ...
     * @private
     */
    _yuitest_coverline("build/node-core/node-core.js", 878);
this._nodes = nodes || [];
};

_yuitest_coverline("build/node-core/node-core.js", 881);
...
NodeList.getDOMNodes = function(nodelist) {
    _yuitest_coverfunc("build/node-core/node-core.js", "getDOMNodes", 891);
_yuitest_coverline("build/node-core/node-core.js", 892);
return (nodelist && nodelist._nodes) ? nodelist._nodes : nodelist;
};

_yuitest_coverline("build/node-core/node-core.js", 895);
NodeList.each = function(instance, fn, context) {
    _yuitest_coverfunc("build/node-core/node-core.js", "each", 895);
...
NodeList.addMethod = function(name, fn, context) {
    _yuitest_coverfunc("build/node-core/node-core.js", "addMethod", 903);
_yuitest_coverline("build/node-core/node-core.js", 904);
if (name && fn) {
        _yuitest_coverline("build/node-core/node-core.js", 905);
NodeList.prototype[name] = function() {
            _yuitest_coverfunc("build/node-core/node-core.js", "]", 905);
...
Y.Array.each(this._nodes, function(node) {
                _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 9)", 909);
...
NodeList.importMethod = function(host, name, altName) {
    _yuitest_coverfunc("build/node-core/node-core.js", "importMethod", 932);
...
Y.Array.each(name, function(n) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 10)", 937);
...
NodeList._getTempNode = function(node) {
    _yuitest_coverfunc("build/node-core/node-core.js", "_getTempNode", 943);
...
Y.mix(NodeList.prototype, {
    _invoke: function(method, args, getter) {
        _yuitest_coverfunc("build/node-core/node-core.js", "_invoke", 956);
_yuitest_coverline("build/node-core/node-core.js", 957);
var ret = (getter) ? [] : this;

        _yuitest_coverline("build/node-core/node-core.js", 959);
this.each(function(node) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 11)", 959);
...
return ret;
     ...
     */
    item: function(index) {
        _yuitest_coverfunc("build/node-core/node-core.js", "item", 976);
_yuitest_coverline("build/node-core/node-core.js", 977);
return Y.one((this._nodes || [])[index]);
    ...
    each: function(fn, context) {
        _yuitest_coverfunc("build/node-core/node-core.js", "each", 989);
_yuitest_coverline("build/node-core/node-core.js", 990);
var instance = this;
        _yuitest_coverline("build/node-core/node-core.js", 991);
Y.Array.each(this._nodes, function(node, index) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 12)", 991);
...
return instance;
    ...
    batch: function(fn, context) {
        _yuitest_coverfunc("build/node-core/node-core.js", "batch", 998);
_yuitest_coverline("build/node-core/node-core.js", 999);
var nodelist = this;

        _yuitest_coverline("build/node-core/node-core.js", 1001);
Y.Array.each(this._nodes, function(node, index) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 13)", 1001);
...
return nodelist;
    ...
    some: function(fn, context) {
        _yuitest_coverfunc("build/node-core/node-core.js", "some", 1021);
_yuitest_coverline("build/node-core/node-core.js", 1022);
var instance = this;
        _yuitest_coverline("build/node-core/node-core.js", 1023);
return Y.Array.some(this._nodes, function(node, index) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 14)", 1023);
...
return fn.call(context, node, index, instance);
     ...
     */
    toFrag: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "toFrag", 1035);
...
return Y.one(Y.DOM._nl2frag(this._nodes));
    ...
    indexOf: function(node) {
        _yuitest_coverfunc("build/node-core/node-core.js", "indexOf", 1046);
_yuitest_coverline("build/node-core/node-core.js", 1047);
return Y.Array.indexOf(this._nodes, Y.Node.getDOMNode(node));
    ...
    filter: function(selector) {
        _yuitest_coverfunc("build/node-core/node-core.js", "filter", 1057);
_yuitest_coverline("build/node-core/node-core.js", 1058);
return Y.all(Y.Selector.filter(this._nodes, selector));
    ...
    modulus: function(n, r) {
        _yuitest_coverfunc("build/node-core/node-core.js", "modulus", 1071);
...
NodeList.each(this, function(node, i) {
            _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 15)", 1074);
...
return Y.all(nodes);
     ...
     */
    odd: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "odd", 1089);
...
return this.modulus(2, 1);
     ...
     */
    even: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "even", 1099);
...
return this.modulus(2);
     ...
     */
    refresh: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "refresh", 1111);
_yuitest_coverline("build/node-core/node-core.js", 1112);
var doc,
            nodes = this._nodes,
            query = this._query,
...
return this;
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "size", 1135);
_yuitest_coverline("build/node-core/node-core.js", 1136);
return this._nodes.length;
     ...
     */
    isEmpty: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "isEmpty", 1144);
_yuitest_coverline("build/node-core/node-core.js", 1145);
return this._nodes.length < 1;
    },

    toString: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "toString", 1148);
_yuitest_coverline("build/node-core/node-core.js", 1149);
var str = '',
...
str += '...[' + nodes.length + ' items]';
        ...
        _yuitest_coverline("build/node-core/node-core.js", 1169);
return str || errorMsg;
    },
    ...
    getDOMNodes: function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "getDOMNodes", 1177);
_yuitest_coverline("build/node-core/node-core.js", 1178);
return this._nodes;
    }
}, true);

_yuitest_coverline("build/node-core/node-core.js", 1182);
...
NodeList.prototype.get = function(attr) {
    _yuitest_coverfunc("build/node-core/node-core.js", "get", 1235);
_yuitest_coverline("build/node-core/node-core.js", 1236);
var ret = [],
        nodes = this._nodes,
        isNodeList = false,
...
Y.Array.each(nodes, function(node) {
        _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 16)", 1251);
...
ret.push(val);
    ...
    _yuitest_coverline("build/node-core/node-core.js", 1266);
...
Y.all = function(nodes) {
    _yuitest_coverfunc("build/node-core/node-core.js", "all", 1271);
_yuitest_coverline("build/node-core/node-core.js", 1272);
return new NodeList(nodes);
};

_yuitest_coverline("build/node-core/node-core.js", 1275);
Y.Node.all = Y.all;
/**
 * @module node
 * @submodule node-core
...
Y.Object.each(ArrayMethods, function(returnNodeList, name) {
    _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 17)", 1341);
_yuitest_coverline("build/node-core/node-core.js", 1342);
Y_NodeList.prototype[name] = function() {
        _yuitest_coverfunc("build/node-core/node-core.js", "]", 1342);
...
while (typeof (arg = arguments[i++]) != 'undefined') { // use DOM nodes/nodeLists
            _yuitest_coverline("build/node-core/node-core.js", 1349);
...
if (returnNodeList) {
            _yuitest_coverline("build/node-core/node-core.js", 1355);
ret = Y.all(ret);
        } else {
...
_yuitest_coverline("build/node-core/node-core.js", 1368);
Y.Array.each([
    /**
    ...
    _yuitest_coverfunc("build/node-core/node-core.js", "(anonymous 18)", 1462);
_yuitest_coverline("build/node-core/node-core.js", 1463);
Y.Node.prototype[method] = function(arg1, arg2, arg3) {
        _yuitest_coverfunc("build/node-core/node-core.js", "]", 1463);
...
Y.Node.prototype.removeAttribute = function(attr) {
    _yuitest_coverfunc("build/node-core/node-core.js", "removeAttribute", 1476);
...
_yuitest_coverline("build/node-core/node-core.js", 1485);
...
_yuitest_coverline("build/node-core/node-core.js", 1537);
