...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2758);
obj = arguments[i];
...
if (hasOwn.call(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 2762);
result[key] = obj[key];
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2767);
return result;
};
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui/yui.js", "mix", 2804);
_yuitest_coverline("build/yui/yui.js", 2805);
var alwaysOverwrite, exists, from, i, key, len, to;

    // If no supplier is given, we return the receiver. If no receiver is given,
    // we return Y. Returning Y doesn't make much sense to me, but it's
    // grandfathered in for backcompat reasons.
    _yuitest_coverline("build/yui/yui.js", 2810);
...
from = mode === 1 || mode === 3 ? supplier.prototype : supplier;
        _yuitest_coverline("build/yui/yui.js", 2826);
to   = mode === 1 || mode === 4 ? receiver.prototype : receiver;

        // If either the supplier or receiver doesn't actually have a
        // prototype property, then we could end up with an undefined `from`
        // or `to`. If that happens, we abort and return the receiver.
        _yuitest_coverline("build/yui/yui.js", 2831);
if (!from || !to) {
            _yuitest_coverline("build/yui/yui.js", 2832);
return receiver;
        }
    } else {
...
to   = receiver;
    ...
    _yuitest_coverline("build/yui/yui.js", 2841);
alwaysOverwrite = overwrite && !merge;

    _yuitest_coverline("build/yui/yui.js", 2843);
if (whitelist) {
        _yuitest_coverline("build/yui/yui.js", 2844);
...
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui/yui.js", 2853);
continue;
            }
...
exists = alwaysOverwrite ? false : key in to;
            ...
            _yuitest_coverline("build/yui/yui.js", 2861);
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2872);
if (overwrite || !exists) {
                // We're not in merge mode, so we'll only copy the `from` value
                // to the `to` value if we're in overwrite mode or if the
                // current key doesn't exist on the `to` object.
                _yuitest_coverline("build/yui/yui.js", 2876);
to[key] = from[key];
            }}
        }
    } else {
...
continue;
            ...
            // compatibility reasons. It prevents undesired shadowing of
            // prototype members on `to`.
            _yuitest_coverline("build/yui/yui.js", 2893);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("build/yui/yui.js", 2895);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("build/yui/yui.js", 2897);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2898);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui/yui.js", 2906);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui/yui.js", 2907);
...
_yuitest_coverline("build/yui/yui.js", 2927);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 18)", 2943);
_yuitest_coverline("build/yui/yui.js", 2949);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 19)", 2950);
_yuitest_coverline("build/yui/yui.js", 2952);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui/yui.js", 2955);
return function (obj) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 20)", 2955);
_yuitest_coverline("build/yui/yui.js", 2956);
F.prototype = obj;
        _yuitest_coverline("build/yui/yui.js", 2957);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui/yui.js", "owns", 3018);
_yuitest_coverline("build/yui/yui.js", 3019);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3054);
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "keys", 3054);
...
throw new TypeError('Object.keys called on a non-object');
    ...
    _yuitest_coverline("build/yui/yui.js", 3059);
var keys = [],
        i, key, len;
...
if (owns(obj, key) && key !== 'prototype') {
                _yuitest_coverline("build/yui/yui.js", 3065);
keys.push(key);
            }
        }
    } else {
...
if (hasEnumBug) {
        _yuitest_coverline("build/yui/yui.js", 3077);
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 3078);
key = forceEnum[i];

            _yuitest_coverline("build/yui/yui.js", 3080);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 3081);
keys.push(key);
            }
        }
    }
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "values", 3106);
_yuitest_coverline("build/yui/yui.js", 3107);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];

    _yuitest_coverline("build/yui/yui.js", 3112);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 3113);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("build/yui/yui.js", 3116);
return values;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3127);
O.size = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "size", 3127);
_yuitest_coverline("build/yui/yui.js", 3128);
try {
        _yuitest_coverline("build/yui/yui.js", 3129);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3145);
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui/yui.js", "hasValue", 3145);
_yuitest_coverline("build/yui/yui.js", 3146);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3169);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "each", 3169);
_yuitest_coverline("build/yui/yui.js", 3170);
var key;

    _yuitest_coverline("build/yui/yui.js", 3172);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3173);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3174);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3178);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3201);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "some", 3201);
_yuitest_coverline("build/yui/yui.js", 3202);
var key;

    _yuitest_coverline("build/yui/yui.js", 3204);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3205);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3206);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui/yui.js", 3207);
return true;
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3212);
return false;
};
 ...
 */
_yuitest_coverline("build/yui/yui.js", 3228);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui/yui.js", "getValue", 3228);
_yuitest_coverline("build/yui/yui.js", 3229);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui/yui.js", 3230);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui/yui.js", 3233);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui/yui.js", 3237);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui/yui.js", 3238);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui/yui.js", 3241);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui/yui.js", "setValue", 3258);
...
var i,
    ...
    _yuitest_coverline("build/yui/yui.js", 3264);
if (leafIdx >= 0) {
        _yuitest_coverline("build/yui/yui.js", 3265);
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui/yui.js", 3266);
ref = ref[p[i]];
        }

        _yuitest_coverline("build/yui/yui.js", 3269);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui/yui.js", 3270);
ref[p[i]] = val;
        } else {
            _yuitest_coverline("build/yui/yui.js", 3272);
return UNDEFINED;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3276);
return o;
};
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 3288);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "isEmpty", 3288);
_yuitest_coverline("build/yui/yui.js", 3289);
...
*/
_yuitest_coverline("build/yui/yui.js", 3324);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui/yui.js", "parseUA", 3324);
_yuitest_coverline("build/yui/yui.js", 3326);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui/yui.js", "numberify", 3326);
_yuitest_coverline("build/yui/yui.js", 3327);
var c = 0;
            _yuitest_coverline("build/yui/yui.js", 3328);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 22)", 3328);
...
o.userAgent = ua;
    ...
    _yuitest_coverline("build/yui/yui.js", 3566);
o.secure = href && (href.toLowerCase().indexOf('https') === 0);

    _yuitest_coverline("build/yui/yui.js", 3568);
if (ua) {
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui/yui.js", 3572);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3573);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui/yui.js", 3574);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3575);
o.os = 'android';
        } else {_yuitest_coverline("build/yui/yui.js", 3576);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3577);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui/yui.js", 3578);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3579);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui/yui.js", 3580);
if ((/rhino/i).test(ua)) {
...
o.mobile = 'windows';
        ...
        _yuitest_coverline("build/yui/yui.js", 3591);
if ((/Fennec/).test(ua)) {
...
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("build/yui/yui.js", 3596);
if (m && m[1]) {
...
o.safari = o.webkit;
            ...
            _yuitest_coverline("build/yui/yui.js", 3600);
...
o.phantomjs = numberify(m[1]);
            ...
            _yuitest_coverline("build/yui/yui.js", 3608);
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3609);
o.mobile = 'Apple'; // iPhone or iPod Touch

                _yuitest_coverline("build/yui/yui.js", 3611);
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3612);
if (m && m[1]) {
...
m = ua.match(/iPad|iPod|iPhone/);
                _yuitest_coverline("build/yui/yui.js", 3620);
if (m && m[0]) {
                    _yuitest_coverline("build/yui/yui.js", 3621);
o[m[0].toLowerCase()] = o.ios;
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 3624);
m = ua.match(/NokiaN[^\/]*|webOS\/\d\.\d/);
                _yuitest_coverline("build/yui/yui.js", 3625);
if (m) {
                    // Nokia N-series, webOS, ex: NokiaN95
                    _yuitest_coverline("build/yui/yui.js", 3627);
o.mobile = m[0];
                }
                _yuitest_coverline("build/yui/yui.js", 3629);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3630);
o.mobile = 'WebOS';
                    _yuitest_coverline("build/yui/yui.js", 3631);
m = ua.match(/webOS\/([^\s]*);/);
...
o.webos = numberify(m[1]);
                ...
                _yuitest_coverline("build/yui/yui.js", 3636);
if (/ Android/.test(ua)) {
...
o.mobile = 'Android';
                    ...
                    _yuitest_coverline("build/yui/yui.js", 3640);
...
o.android = numberify(m[1]);
                ...
                _yuitest_coverline("build/yui/yui.js", 3646);
if (/Silk/.test(ua)) {
...
o.android = 2.34; //Hack for desktop mode in Kindle
                        _yuitest_coverline("build/yui/yui.js", 3653);
o.os = 'Android';
                    }
...
o.accel = true;
            ...
            _yuitest_coverline("build/yui/yui.js", 3661);
m = ua.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/);
            _yuitest_coverline("build/yui/yui.js", 3662);
if (m && m[1] && m[2]) {
                _yuitest_coverline("build/yui/yui.js", 3663);
...
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3679);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3680);
if (m && m[1]) {
...
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3685);
...
o.mobile = 'opera';
                    _yuitest_coverline("build/yui/yui.js", 3690);
...
m = ua.match(/Opera Mini[^;]*/);
                ...
                _yuitest_coverline("build/yui/yui.js", 3697);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 3698);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("build/yui/yui.js", 3701);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui/yui.js", 3702);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3703);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui/yui.js", 3705);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 3706);
if (m) {
                        _yuitest_coverline("build/yui/yui.js", 3707);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("build/yui/yui.js", 3708);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui/yui.js", 3709);
if (m && m[1]) {
                            _yuitest_coverline("build/yui/yui.js", 3710);
...
if (win && nav && !(o.chrome && o.chrome < 6)) {
        _yuitest_coverline("build/yui/yui.js", 3721);
o.touchEnabled = (("ontouchstart" in win) || (("msMaxTouchPoints" in nav) && (nav.msMaxTouchPoints > 0)));
    }

    //It was a parsed UA, do not assign the global value.
    _yuitest_coverline("build/yui/yui.js", 3725);
if (!subUA) {

        _yuitest_coverline("build/yui/yui.js", 3727);
if (typeof process === 'object') {

            _yuitest_coverline("build/yui/yui.js", 3729);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("build/yui/yui.js", 3731);
o.os = process.platform;
                _yuitest_coverline("build/yui/yui.js", 3732);
o.nodejs = numberify(process.versions.node);
            }
        }

        _yuitest_coverline("build/yui/yui.js", 3736);
YUI.Env.UA = o;

    }

    _yuitest_coverline("build/yui/yui.js", 3740);
return o;
};


_yuitest_coverline("build/yui/yui.js", 3744);
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("build/yui/yui.js", 3766);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "compareVersions", 3766);
_yuitest_coverline("build/yui/yui.js", 3767);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui/yui.js", 3769);
if (a === b) {
        _yuitest_coverline("build/yui/yui.js", 3770);
return 0;
    }

    _yuitest_coverline("build/yui/yui.js", 3773);
aParts = (a + '').split('.');
    _yuitest_coverline("build/yui/yui.js", 3774);
bParts = (b + '').split('.');

    _yuitest_coverline("build/yui/yui.js", 3776);
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 3777);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui/yui.js", 3778);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("build/yui/yui.js", 3780);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui/yui.js", 3781);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui/yui.js", 3783);
if (aPart < bPart) {
            _yuitest_coverline("build/yui/yui.js", 3784);
return -1;
        }

        _yuitest_coverline("build/yui/yui.js", 3787);
if (aPart > bPart) {
            _yuitest_coverline("build/yui/yui.js", 3788);
return 1;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3792);
return 0;
};
_yuitest_coverline("build/yui/yui.js", 3794);
YUI.Env.aliases = {
