		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-datatable': {submodules: {'aui-datatable-edit': {skinnable:true, requires:['aui-base','datatable','plugin']}, 'aui-datatable-events': {requires:['aui-base','datatable','plugin']} }, skinnable:false, use:['aui-datatable-events','aui-datatable-edit']},
						...
						'aui-form-builder': {submodules: {'aui-form-builder-field': {skinnable:true, requires:['aui-datatype','aui-form','aui-panel','io','substitute']}, 'aui-form-builder-base': {skinnable:true, requires:['aui-base','aui-button-item','aui-nested-list','aui-tabs','substitute']} }, skinnable:true, use:['aui-form-builder-base','aui-form-builder-field']},
