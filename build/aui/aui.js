		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-event': {submodules: {'aui-event-delegate-change': {requires:['aui-base']}, 'aui-event-input': {requires:['aui-base']}, 'aui-event-base': {requires:['event']} }, plugins:{'aui-event-delegate-change': {condition: {trigger: 'event-base-ie', ua: 'ie'}}}, use:['aui-event-base','aui-event-input'], skinnable:false},
