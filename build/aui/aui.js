		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-diagram-builder': {submodules: {'aui-diagram-builder-impl': {requires:['aui-diagram-builder-base','overlay'], skinnable:true}, 'aui-diagram-builder-base': {requires:['aui-tabs','aui-property-list','collection','dd'], skinnable:true} }, use:['aui-diagram-builder-base','aui-diagram-builder-impl'], skinnable:true},
