		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-form-builder': {submodules: {'aui-form-builder-field': {skinnable:true, requires:['aui-datatype','aui-form','aui-panel','aui-tooltip','io','substitute']}, 'aui-form-builder-base': {skinnable:true, requires:['aui-base','aui-button-item','aui-nested-list','aui-tabs','substitute']} }, skinnable:true, use:['aui-form-builder-base','aui-form-builder-field']},
