		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-calendar': {submodules: {'aui-calendar-base': {skinnable:true, requires:['aui-overlay-context','datatype-date','widget-locale']} }, skinnable:true, use:['aui-calendar-base']},
						...
						'aui-color-picker': {skinnable:true, requires:['aui-overlay-context','dd-drag','slider','substitute','aui-button-item','aui-form-base','aui-panel']},
						...
						'aui-datepicker-select': {skinnable:true, requires:['aui-calendar-base','aui-button-item']},
						...
						'aui-resize': {skinnable:true, requires:['aui-base','dd-constrain','dd-drag','dd-drop','substitute']},
