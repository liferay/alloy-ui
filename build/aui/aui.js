		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-datepicker': {submodules: {'aui-datepicker-select': {requires:['aui-calendar','aui-button-item'], skinnable:true}, 'aui-datepicker-base': {requires:['aui-calendar','aui-overlay-context'], skinnable:true} }, skinnable:true, use:['aui-datepicker-base','aui-datepicker-select']},
