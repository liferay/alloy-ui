		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-datatable': {submodules: {'aui-datatable-edit': {requires:['aui-base','datatable','plugin'], skinnable:true}, 'aui-datatable-events': {requires:['aui-base','datatable','plugin']} }, use:['aui-datatable-events','aui-datatable-edit'], skinnable:false},
						...
						'aui-scroller': {requires:['aui-base','anim-node-plugin'], skinnable:true},
