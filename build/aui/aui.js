...
YUI.add('yui', function(Y){}, '3.6.0pr1' ,{use:['yui-base','get','features','intl-base','yui-log','yui-later','loader-base', 'loader-rollup', 'loader-yui3']});
		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-datatable': {submodules: {'aui-datatable-selection': {requires:['datatable-base'], skinnable:true}, 'aui-datatable-edit': {requires:['datatable-base','aui-calendar','aui-toolbar','aui-form-validator','overlay','sortable'], skinnable:true} }, skinnable:true, use:['aui-datatable-edit','aui-datatable-selection']},
