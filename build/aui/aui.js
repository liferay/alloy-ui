		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-form-builder': {submodules: {'aui-form-builder-field': {requires:['aui-datatype','aui-form','aui-panel','aui-tooltip','io','substitute'], skinnable:true}, 'aui-form-builder-base': {requires:['aui-base','aui-button-item','aui-nested-list','aui-tabs','substitute'], skinnable:true} }, skinnable:true, use:['aui-form-builder-base','aui-form-builder-field']},
						...
						'aui-tree': {submodules: {'aui-tree-view': {requires:['aui-tree-node','dd-drag','dd-drop','dd-proxy'], skinnable:true}, 'aui-tree-node': {requires:['aui-tree-data','io-base','json','querystring-stringify'], skinnable:false}, 'aui-tree-data': {requires:['aui-base'], skinnable:false} }, skinnable:true, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-view']},
