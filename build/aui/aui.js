		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-data-browser': {requires:['aui-base','aui-tree','aui-panel','datasource','dataschema','aui-form-combobox'], skinnable:true},
						...
						'aui-editor': {submodules: {'aui-editor-bbcode-plugin': {requires:['aui-base','editor-base']}, 'aui-editor-toolbar-plugin': {requires:['aui-base','editor-base','aui-toolbar','aui-overlay-context','aui-panel','aui-color-picker','aui-editor-menu-plugin','aui-editor-tools-plugin','aui-button-item','createlink-base','editor-lists','plugin']}, 'aui-editor-menu-plugin': {requires:['aui-base','editor-base','aui-overlay-context','aui-panel','aui-editor-tools-plugin']}, 'aui-editor-tools-plugin': {requires:['aui-base','editor-base']} }, use:['aui-editor-tools-plugin','aui-editor-menu-plugin','aui-editor-toolbar-plugin','aui-editor-bbcode-plugin'], skinnable:true},
