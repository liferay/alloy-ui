		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-form-builder': {submodules: {'aui-form-builder-field': {requires:['aui-datatype','aui-form','aui-panel','aui-tooltip','io','substitute'], skinnable:true}, 'aui-form-builder-base': {requires:['aui-base','aui-button-item','aui-nested-list','aui-tabs','substitute'], skinnable:true} }, use:['aui-form-builder-base','aui-form-builder-field'], skinnable:true},
