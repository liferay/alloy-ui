Alloy.add('rating', function(AUI) {
	...
	var L = AUI.Lang;
	var isBoolean = L.isBoolean;
	var isNumber = L.isNumber;
	var isString = L.isString;
	...
	var C_CLEAR_FIX = 'aui-helper-clearfix';
	var C_RATING_DISABLED = getCN(RATING, DISABLED);
	var C_RATING_EL = getCN(RATING, ELEMENT);
	var C_RATING_EL_HOVER  = getCN(RATING, ELEMENT, HOVER);
	var C_RATING_EL_OFF = getCN(RATING, ELEMENT, OFF);
	var C_RATING_EL_ON = getCN(RATING, ELEMENT, ON);
