...
var L = A.Lang,
    ...
    TPL_INPUT = '<div class="row form-builder-field-wrapper"><input id="{id}" class="' + [CSS_FORM_BUILDER_FIELD_NODE, CSS_FIELD_INPUT, CSS_FIELD_INPUT_TEXT,
        CSS_FORM_CONTROL].join(' ') + '" name="{name}" type="text" value="{value}" /></div>',

    WIDTH_VALUES_MAP = {
        small: 'col-xs-5 col-sm-3 col-md-3',
        medium: 'col-xs-6 col-sm-5 col-md-5',
        large: 'col-xs-12 col-sm-7 col-md-7'
    };
