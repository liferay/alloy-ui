...
java.lang.Boolean alwaysShowContainer = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:alwaysShowContainer"), false);
java.lang.Boolean applyLocalFilter = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:applyLocalFilter"), true);
java.lang.Boolean autoHighlight = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:autoHighlight"), true);
java.lang.Boolean button = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:button"), true);
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:disabled"), false);
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:focused"), false);
java.lang.Boolean forceSelection = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:forceSelection"), false);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:initialized"), false);
...
java.lang.Boolean queryMatchCase = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:queryMatchCase"), false);
java.lang.Boolean queryMatchContains = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:queryMatchContains"), false);
java.lang.Boolean queryQuestionMark = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:queryQuestionMark"), true);
java.lang.Object render = (java.lang.Object)request.getAttribute("liferay:auto-complete:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:rendered"), false);
java.util.HashMap schema = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("liferay:auto-complete:schema")));
...
java.util.HashMap strings = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("liferay:auto-complete:strings")));
java.lang.Boolean suppressInputUpdate = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:suppressInputUpdate"), false);
java.lang.Number tabIndex = GetterUtil.getNumber(String.valueOf(request.getAttribute("liferay:auto-complete:tabIndex")), 0);
java.lang.Boolean typeAhead = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:typeAhead"), false);
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("liferay:auto-complete:visible"), true);
