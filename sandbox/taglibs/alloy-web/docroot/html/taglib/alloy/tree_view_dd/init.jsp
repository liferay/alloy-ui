...
java.lang.Boolean checked = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tree-view-dd:checked"), false);
java.util.ArrayList children = _getArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:tree-view-dd:children"), "[]"));
java.lang.String container = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:tree-view-dd:container"));
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tree-view-dd:destroyed"), false);
...
java.util.HashMap index = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:tree-view-dd:index"), "{}"));
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tree-view-dd:initialized"), false);
java.util.HashMap io = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:tree-view-dd:io")));
