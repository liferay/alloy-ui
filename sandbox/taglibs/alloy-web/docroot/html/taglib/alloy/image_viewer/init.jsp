...
java.lang.Boolean anim = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:anim"), true);
...
java.lang.Boolean captionFromTitle = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:captionFromTitle"), true);
java.lang.Boolean centered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:centered"), true);
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:disabled"), false);
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:image-viewer:fillHeight");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:focused"), false);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:initialized"), false);
...
java.lang.Boolean loading = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:loading"), false);
...
java.lang.Boolean preloadAllImages = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:preloadAllImages"), false);
java.lang.Boolean preventOverlap = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:preventOverlap"), false);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:image-viewer:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:rendered"), false);
java.lang.Boolean shim = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:shim"), false);
java.lang.Boolean showArrows = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:showArrows"), true);
java.lang.Boolean showClose = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:showClose"), true);
...
java.lang.Boolean totalLinks = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:totalLinks"), true);
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:image-viewer:visible"), true);
