...
java.util.HashMap xdr = _toHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:io-request:xdr")));
...
_updateOptions(_options, "selector", selector);
