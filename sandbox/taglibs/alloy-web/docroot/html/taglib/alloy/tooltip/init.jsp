...
java.lang.Boolean cancellableHide = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:cancellableHide"), true);
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:disabled"), false);
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:tooltip:fillHeight");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:focused"), false);
...
java.lang.Boolean hideOnDocumentClick = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:hideOnDocumentClick"), true);
java.lang.String tooltipId = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:tooltip:tooltipId"));
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:initialized"), false);
java.lang.Boolean preventOverlap = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:preventOverlap"), false);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:tooltip:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:rendered"), false);
java.lang.Boolean shim = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:shim"), false);
java.lang.Boolean showArrow = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:showArrow"), true);
...
java.lang.Boolean stack = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:stack"), true);
...
java.lang.Boolean title = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:title"), false);
java.lang.Object trigger = (java.lang.Object)request.getAttribute("alloy:tooltip:trigger");
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:tooltip:visible"), false);
