...
java.util.ArrayList _appendOrder = JSONFactoryUtil.getArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:date-picker-select:appendOrder")));
...
java.util.ArrayList _yearRange = JSONFactoryUtil.getArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:date-picker-select:yearRange")));
