...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:disabled"), false);
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:focused"), false);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:initialized"), false);
...
java.lang.Boolean populateDay = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:populateDay"), true);
java.lang.Boolean populateMonth = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:populateMonth"), true);
java.lang.Boolean populateYear = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:populateYear"), true);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:date-picker-select:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:rendered"), false);
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:date-picker-select:visible"), true);
