...
java.lang.Boolean _cancellableHide = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:cancellableHide"), true);
...
java.lang.Number _currentDay = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:currentDay"), 0);
java.lang.Number _currentMonth = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:currentMonth"), 0);
...
java.lang.Number _currentYear = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:currentYear"), 0);
java.lang.String _dateFormat = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:date-picker-select:dateFormat"), "%m/%d/%Y");
java.lang.Object _dates = (java.lang.Object)request.getAttribute("alloy:date-picker-select:dates");
...
java.lang.Number _firstDayOfWeek = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:firstDayOfWeek"), 0);
...
java.lang.Number _hideDelay = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:hideDelay"), 0);
java.lang.String _hideOn = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:date-picker-select:hideOn"));
java.lang.Boolean _hideOnDocumentClick = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:hideOnDocumentClick"), true);
...
java.lang.Boolean _preventOverlap = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:preventOverlap"), false);
...
java.lang.Boolean _selectMultipleDates = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:selectMultipleDates"), false);
...
java.lang.Boolean _setValue = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:setValue"), false);
java.lang.Boolean _shim = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:shim"), false);
java.lang.Number _showDelay = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:showDelay"), 0);
...
java.lang.Boolean _stack = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:stack"), true);
...
java.lang.Boolean _visible = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:date-picker-select:visible"), false);
java.lang.String _width = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:date-picker-select:width"));
java.lang.Number _x = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:x"), 0);
java.lang.Object _xy = (java.lang.Object)request.getAttribute("alloy:date-picker-select:xy");
java.lang.Number _y = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:y"), 0);
...
java.lang.Number _zIndex = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:date-picker-select:zIndex"), 0);
