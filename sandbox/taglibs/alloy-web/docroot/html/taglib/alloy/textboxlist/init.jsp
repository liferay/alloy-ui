...
<%
java.lang.Boolean alwaysShowContainer = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:alwaysShowContainer"), false);
java.lang.Boolean applyLocalFilter = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:applyLocalFilter"), true);
java.lang.Boolean autoHighlight = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:autoHighlight"), true);
java.lang.Boolean button = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:button"), true);
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:disabled"), false);
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:focused"), false);
java.lang.Boolean forceSelection = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:forceSelection"), false);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:initialized"), false);
...
java.lang.Boolean queryMatchCase = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:queryMatchCase"), false);
java.lang.Boolean queryMatchContains = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:queryMatchContains"), false);
java.lang.Boolean queryQuestionMark = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:queryQuestionMark"), true);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:textboxlist:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:rendered"), false);
java.util.HashMap schema = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:textboxlist:schema")));
...
java.util.HashMap strings = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:textboxlist:strings")));
java.lang.Boolean suppressInputUpdate = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:suppressInputUpdate"), false);
java.lang.Number tabIndex = GetterUtil.getNumber(String.valueOf(request.getAttribute("alloy:textboxlist:tabIndex")), 0);
java.lang.Boolean typeAhead = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:typeAhead"), false);
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:textboxlist:visible"), true);
