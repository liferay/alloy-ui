...
java.lang.String hideClass = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:overlay-context-panel:hideClass"), "yui3-aui-helper-hidden");
...
java.util.HashMap strings = _toHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:overlay-context-panel:strings")));
...
boolean useARIA = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:useARIA")), true);
...
java.util.ArrayList xy = _toArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:overlay-context-panel:xy"), "[0,0]"));
...
java.lang.Object afterUseARIAChange = (java.lang.Object)request.getAttribute("alloy:overlay-context-panel:afterUseARIAChange");
...
java.lang.Object onUseARIAChange = (java.lang.Object)request.getAttribute("alloy:overlay-context-panel:onUseARIAChange");
