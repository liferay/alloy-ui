...
java.lang.Boolean activeState = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:activeState"), false);
...
java.lang.Boolean defaultState = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:defaultState"), false);
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:disabled"), false);
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:focused"), false);
...
java.lang.Boolean hoverState = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:hoverState"), false);
java.lang.String toolbarId = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:toolbar:toolbarId"));
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:initialized"), false);
java.lang.Boolean multiple = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:multiple"), false);
...
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:rendered"), false);
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:toolbar:visible"), true);
