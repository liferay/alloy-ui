...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:disabled"), false);
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:overlay-mask:fillHeight");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:focused"), false);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:initialized"), false);
java.lang.Number opacity = GetterUtil.getNumber(String.valueOf(request.getAttribute("alloy:overlay-mask:opacity")), 0.5);
java.lang.Boolean preventOverlap = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:preventOverlap"), false);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:overlay-mask:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:rendered"), false);
java.lang.Boolean shim = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:shim"), false);
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:overlay-mask:visible"), false);
