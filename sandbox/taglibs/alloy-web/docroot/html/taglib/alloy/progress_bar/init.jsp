...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:progress-bar:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:progress-bar:disabled"), false);
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:progress-bar:focused"), false);
java.lang.Integer height = GetterUtil.getInteger(String.valueOf(request.getAttribute("alloy:progress-bar:height")), 25);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:progress-bar:initialized"), false);
java.lang.String label = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:progress-bar:label"));
java.lang.Integer max = GetterUtil.getInteger(String.valueOf(request.getAttribute("alloy:progress-bar:max")), 100);
java.lang.Integer min = GetterUtil.getInteger(String.valueOf(request.getAttribute("alloy:progress-bar:min")), 0);
...
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:progress-bar:rendered"), false);
...
java.util.HashMap strings = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:progress-bar:strings")));
...
java.lang.Integer progressbarValue = GetterUtil.getInteger(String.valueOf(request.getAttribute("alloy:progress-bar:progressbarValue")), 0);
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:progress-bar:visible"), true);
