...
<%
java.lang.Boolean canReset = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:canReset"), true);
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:disabled"), false);
java.lang.Object elements = (java.lang.Object)request.getAttribute("alloy:thumb-rating:elements");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:focused"), false);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:initialized"), false);
...
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:rendered"), false);
...
java.lang.Boolean showTitle = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:showTitle"), true);
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:thumb-rating:visible"), true);
