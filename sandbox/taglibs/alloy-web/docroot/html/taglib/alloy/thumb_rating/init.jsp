...
java.lang.String hideClass = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:thumb-rating:hideClass"), "yui3-aui-helper-hidden");
...
java.util.HashMap strings = _toHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:thumb-rating:strings")));
...
boolean useARIA = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:thumb-rating:useARIA")), true);
...
java.lang.Object afterUseARIAChange = (java.lang.Object)request.getAttribute("alloy:thumb-rating:afterUseARIAChange");
...
java.lang.Object onUseARIAChange = (java.lang.Object)request.getAttribute("alloy:thumb-rating:onUseARIAChange");
