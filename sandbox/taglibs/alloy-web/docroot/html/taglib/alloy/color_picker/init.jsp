...
<%
java.util.HashMap align = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:color-picker:align"), "{ node: null, points: [ TL, BL ] }"));
java.lang.Object colorpickerBodyContent = (java.lang.Object)request.getAttribute("alloy:color-picker:colorpickerBodyContent");
java.lang.Boolean cancellableHide = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:cancellableHide"), true);
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:disabled"), false);
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:color-picker:fillHeight");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:focused"), false);
...
java.lang.Boolean hideOnDocumentClick = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:hideOnDocumentClick"), true);
...
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:initialized"), false);
java.lang.Boolean preventOverlap = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:preventOverlap"), false);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:color-picker:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:rendered"), false);
java.lang.Boolean shim = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:shim"), false);
...
java.util.HashMap strings = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:color-picker:strings")));
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:color-picker:visible"), false);
...
java.util.ArrayList xy = _getArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:color-picker:xy"), "[0,0]"));
