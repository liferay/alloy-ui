...
<%
java.lang.String NAMESPACE = "alloy:panel:";
...
java.lang.Boolean collapsed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:collapsed"), false);
java.lang.Boolean collapsible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:collapsible"), false);
java.lang.String cssClass = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:panel:cssClass"));
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:disabled"), false);
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:panel:fillHeight");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:focused"), false);
...
java.util.ArrayList icons = _getArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:panel:icons"), "[]"));
java.lang.String panelId = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:panel:panelId"));
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:initialized"), false);
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:panel:render");
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:rendered"), false);
java.util.HashMap strings = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:panel:strings")));
...
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:panel:visible"), true);
