...
<%
java.lang.String NAMESPACE = "alloy:editable:";
...
java.lang.Boolean destroyed = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:editable:destroyed"), false);
java.lang.Boolean disabled = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:editable:disabled"), false);
java.lang.String eventType = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:editable:eventType"), "click");
java.lang.Boolean focused = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:editable:focused"), false);
...
java.util.ArrayList icons = _getArrayList(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:editable:icons"), "[]"));
java.lang.String editableId = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:editable:editableId"));
java.lang.Boolean initialized = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:editable:initialized"), false);
...
java.lang.Boolean rendered = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:editable:rendered"), false);
java.lang.String saveButton = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:editable:saveButton"));
java.util.HashMap strings = _getHashMap(GetterUtil.getObject((java.lang.Object)request.getAttribute("alloy:editable:strings")));
java.lang.Number tabIndex = GetterUtil.getNumber(String.valueOf(request.getAttribute("alloy:editable:tabIndex")), 0);
java.lang.Boolean visible = GetterUtil.getBoolean((java.lang.Boolean)request.getAttribute("alloy:editable:visible"), true);
