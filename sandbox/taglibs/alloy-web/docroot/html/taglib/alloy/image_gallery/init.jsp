...
java.lang.Boolean _anim = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:anim"));
...
java.lang.Boolean _autoPlay = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:autoPlay"));
...
java.lang.Boolean _captionFromTitle = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:captionFromTitle"));
java.lang.Boolean _centered = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:centered"));
...
java.lang.Number _currentIndex = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:currentIndex"));
java.lang.Number _delay = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:delay"));
java.lang.Boolean _destroyed = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:destroyed"));
java.lang.Boolean _disabled = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:disabled"));
java.lang.String _fillHeight = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:fillHeight"));
java.lang.Boolean _focused = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:focused"));
...
java.lang.String _hideClass = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:hideClass"));
...
java.lang.String _infoTemplate = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:infoTemplate"));
java.lang.Boolean _initialized = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:initialized"));
...
java.lang.Boolean _loading = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:loading"));
java.lang.String _loadingEl = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:loadingEl"));
java.lang.Number _maxHeight = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:maxHeight"));
java.lang.Number _maxWidth = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:maxWidth"));
java.lang.String _modal = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:modal"));
...
java.lang.Boolean _paused = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:paused"));
java.lang.String _pausedLabel = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:pausedLabel"));
java.lang.Boolean _playing = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:playing"));
java.lang.String _playingLabel = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:playingLabel"));
java.lang.Boolean _preloadAllImages = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:preloadAllImages"));
java.lang.Boolean _preventOverlap = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:preventOverlap"));
java.lang.Boolean _render = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:render"));
java.lang.Boolean _rendered = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:rendered"));
java.lang.Boolean _repeat = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:repeat"));
java.lang.Boolean _shim = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:shim"));
java.lang.Boolean _showArrows = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:showArrows"));
java.lang.Boolean _showClose = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:showClose"));
java.lang.Boolean _showPlayer = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:showPlayer"));
...
java.lang.Number _tabIndex = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:tabIndex"));
java.lang.String _toolbar = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:toolbar"));
java.lang.Boolean _totalLinks = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:totalLinks"));
java.lang.Boolean _useOriginalImage = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:useOriginalImage"));
java.lang.Boolean _visible = GetterUtil.getBoolean((java.lang.String)request.getAttribute("alloy:image-gallery:visible"));
java.lang.String _width = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:width"));
java.lang.Number _x = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:x"));
java.lang.String _xy = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:image-gallery:xy"));
java.lang.Number _y = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:y"));
java.lang.Number _zIndex = GetterUtil.getNumber((java.lang.String)request.getAttribute("alloy:image-gallery:zIndex"));
